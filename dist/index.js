...
var require_axios = __commonJS({
  "node_modules/axios/lib/axios.js"(exports, module2) {
    ...
    axios6.Axios = Axios;
    axios6.CanceledError = require_CanceledError();
    axios6.CancelToken = require_CancelToken();
    axios6.isCancel = require_isCancel();
    axios6.VERSION = require_data().version;
    axios6.toFormData = require_toFormData();
    axios6.AxiosError = require_AxiosError();
...
var fetchAccessToken = async (clientId, clientSecret) => {
  ...
  try {
    const {
      data: { access_token }
    } = await import_axios5.default.post("https://us.auth.sinch.com/oauth2/token", data, config);
    return access_token;
  } catch {
