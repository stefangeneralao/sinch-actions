...
var deleteContact_exports = {};
__export(deleteContact_exports, {
  deleteContact: () => deleteContact
});
module.exports = __toCommonJS(deleteContact_exports);
...
var deleteContact = async ({
  ...
  try {
    await import_axios.default.delete(`https://us.conversation.api.sinch.com/v1/projects/${projectId}/contacts/${contactId}`, config);
  } catch (e) {
