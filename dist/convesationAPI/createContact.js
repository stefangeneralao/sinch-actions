...
var createContact_exports = {};
__export(createContact_exports, {
  createContact: () => createContact
});
module.exports = __toCommonJS(createContact_exports);
...
var createContact = async ({
  ...
  try {
    await import_axios.default.post(`https://us.conversation.api.sinch.com/v1/projects/${projectId}/contacts`, data, config);
  } catch (e) {
