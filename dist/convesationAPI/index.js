...
// src/convesationAPI/index.ts
var convesationAPI_exports = {};
__export(convesationAPI_exports, {
  createContact: () => createContact,
  deleteContact: () => deleteContact,
  listContacts: () => listContacts,
  sendMessage: () => sendMessage
});
module.exports = __toCommonJS(convesationAPI_exports);

// src/convesationAPI/listContacts.ts
var import_axios = __toESM(require_axios2());
var listContacts = async ({ projectId, accessToken }) => {
  try {
    const config = {
      headers: {
    ...
    const resp = await import_axios.default.get(`https://us.conversation.api.sinch.com/v1/projects/${projectId}/contacts`, config);
...
// src/convesationAPI/createContact.ts
var import_axios2 = __toESM(require_axios2());
var createContact = async ({
  projectId,
  accessToken,
  contactName,
  contactIdentities
  ...
  try {
    await import_axios2.default.post(`https://us.conversation.api.sinch.com/v1/projects/${projectId}/contacts`, data, config);
  } catch (e) {
...
var sendMessage = async ({
  ...
  try {
    await import_axios3.default.post(`https://us.conversation.api.sinch.com/v1/projects/${projectId}/messages:send`, data, config);
  } catch (e) {
...
var deleteContact = async ({
  ...
  try {
    await import_axios4.default.delete(`https://us.conversation.api.sinch.com/v1/projects/${projectId}/contacts/${contactId}`, config);
  } catch (e) {
